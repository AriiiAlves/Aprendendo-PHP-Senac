...
<body>
    ...
    <main>
        <div class="container user edit_user">
            <div>
                <label>Nome completo</label>
                <input type="text" name="nome" id="nome" placeholder="Nome completo" value="<?= $login ?>" required>
                <label>Email</label>
    ...
    <script>
        ...
        function submitForm() {
            ...
            if (senha === senha2) {
                ...
                xhr.open('POST', '../../../../functions/change_user.php', true);
                ...
                var params = `usu_id=${<?= $usu_id ?>}&login=${login}&email=${email}&senha=${senha}&status=${status}`;

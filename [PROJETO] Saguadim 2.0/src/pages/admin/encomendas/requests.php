...
<body>
    <nav>
        ...
        <div class="ul_container">
            ...
            <h2>Encomendas</h2>
            <ul>
                <li><a href="requests.php" class="selected">Solicitadas</a></li> 
    ...
    <main>
        ...
        <h2>Pedidos encomendados</h2>
            ...
            // Busca os id's de venda únicos (um id representa um pacote de encomenda, e vários itens_venda) de encomendas SOLICITADAS
            ...
            while($tbl = mysqli_fetch_array($retorno)) {
                ...
                <button onclick="viewTable(<?= $codigoVenda ?>)">
                    ...
                    <p>Situação: Aguardando preparo</p>
                </button>

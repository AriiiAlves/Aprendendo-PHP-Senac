...
<body>
    <nav>
        ...
        <div class="ul_container">
            ...
            <ul>
                ...
                <li><a href="waiting.php" class="selected">Aguardando retirada</a></li>
                <li><a href="concluded.php">Concluídas</a></li>
            </ul>
        </div>
    ...
    <main>
        ...
        <h2>Pedidos aguardando retirada</h2>
            ...
            // Busca os id's de venda únicos (um id representa um pacote de encomenda, e vários itens_venda) de encomendas AGUARDANDO RETIRADA
            ...
            while($tbl = mysqli_fetch_array($retorno)) {
                ...
                <button onclick="viewTable(<?= $codigoVenda ?>)">
                    ...
                    <p>Situação: Pronto para retirada</p>
                </button>
                ...
                <div id="info<?= $codigoVenda ?>" class="info">
                    ...
                    ?>
                    <div>
                        <button onclick="deliveryState(<?= $codigoVenda ?>, 's')" class="requests">Em preparo</button>
                        <button onclick="deliveryState(<?= $codigoVenda ?>, 'n')" class="concluded">Concluído</button>
                    </div>
                </div>
    ...
    function deliveryState(vendaId, estado) {
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                else if (response === "1" && estado === "n") {
                    window.alert("Encomenda movida para 'Concluídas' com sucesso.")
                    window.location.reload();
                }
            }
        }
